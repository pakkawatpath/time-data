...
if (!$_SESSION["UserID"]) {
    ...
    $sqldbs = "SELECT * FROM dbs WHERE `PersonID` = '$user' AND ($sqldoor) ORDER BY `Time` DESC LIMIT $Page_Start , $Per_Page";
    $objQuery = mysqli_query($conn, "SELECT * FROM dbs WHERE `PersonID` = '$user' AND ($sqldoor)");
